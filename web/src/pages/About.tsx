        ...
        // <div style={pageStyles}>
            <div className="container mt-5">
                    <div className="col-lg-12">
                            ...
                            <p>At ConcertCrafter, we are dedicated to exceeding expectations and creating moments that inspire and entertain. Contact us today to start planning your next unforgettable music event!</p>
                    </div>
            </div>
        // </div>
    );
