                ...
                <div className="row align-items-center justify-content-center">
                    ...
                    <div className="col-lg-12">
                        <div className="pr-4">
                            ...
                            <p>Welcome to MEM, your premier destination for music event management services! At MEM, we are passionate about curating unforgettable musical experiences that leave a lasting impression on our clients and attendees alike.</p>
